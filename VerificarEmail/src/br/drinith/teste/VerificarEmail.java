...
public class VerificarEmail {
	...
	public static boolean isAddressValid(Email email) {
	    // Find the separator for the domain name
	    int pos = email.endereco.indexOf('@');
	    ...
	    String domain = email.endereco.substring(++pos);
	    ...
	    for (int mx = 0; mx < mxList.size(); mx++) {
	        ...
	        try {
	            ...
	            say(wtr, "RCPT TO: <" + email.endereco + ">");
	            res = hear(rdr);
